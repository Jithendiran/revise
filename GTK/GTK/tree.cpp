...
static void create_window(GtkWidget *widget, gpointer data)
{
    ...
    char value[1024] = {0};  // or gchar if you prefer
...
/*
doubts
strcat appends characters starting at value and moves forward in increasing addresses (towards higher addresses).
how strcat work in heap and stack memory
*/