...
void main(){
    ...
    if (4 > 5) printf("%d is greater\n", 4); else printf("%d is greater\n", 5);;
    if (6 > 5) printf("%d is greater\n", 6); else printf("%d is greater\n", 5);;
# 40 "preprocessor_1.c"
   printf("%d\n",2+2 * 3+3);
# 52 "preprocessor_1.c"
printf("%s\n","05:34:55");
